...
class MyMap2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        val sharedPref = PreferenceManager.getDefaultSharedPreferences(this@MyMap2)           //gets session to load
        ...
        val playersGet = object : ValueEventListener{
            override fun onDataChange(p0: DataSnapshot) {
                p0.children.forEach{
                    if((it.key != userid)&&(it.key != "absoluteReady"))
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                // Get Post object and use the values to update the UI
                    p2Dist = dataSnapshot.child("distance").getValue() as Double
                    p2Long = dataSnapshot.child("long").getValue() as Double
                    p2Lat = dataSnapshot.child("lat").getValue() as Double
                                    // ...
            }
        ...
        rtdb.child("sessionManager").child("sessionIndex").child(sessionID).child("locations").child(players[0]).addValueEventListener(postListener)
        ...
        //TODO: I think the map still needs to be initialized
